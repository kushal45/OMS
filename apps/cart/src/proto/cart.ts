...
export interface ProtoGrpcType {
  cart: {
    CartItemDto: MessageTypeDefinition
    CartResponseDto: MessageTypeDefinition
    CartService: SubtypeConstructor<typeof grpc.Client, _cart_CartServiceClient> & { service: _cart_CartServiceDefinition }
    ClearCartByUserIdRequest: MessageTypeDefinition
    ClearCartByUserIdResponse: MessageTypeDefinition
    GetActiveCartByUserIdRequest: MessageTypeDefinition
  }
}
